# Attempt 4 FAILED 派发与完整性回执（原始证据）

状态：`FAILED_STATIC_APPLICATION_AUDIT`

> 此回执保留 Attempt 4 的实际派发事实与原始哈希；后续字段级审计推翻了当时的 GREEN 判定。RAW PROMPT / RAW OUTPUT 字节未改。
...
| --- | --- | --- | --- |
| 只读展示型报表 | `81fe54674d9037f72e01b9290235005a72cb88228c5ed2bc03c8b177597928d7` | `3041f6c4d360b027ca315aea2d6ac999780251b068fddc2403bd779edc4ee39e` | [attempt-4-display-report.md](attempt-4-display-report.md) |
| 单行操作管理列表 | `111068c5e27c3cb8a555eabfe0be3ed97056441f9be9c860589bdcb1f869ed6e` | `4209ee2ed899f12df7d584e60b7c0c99dbb6b6f574c4dbc722a4bde6eaa281ef` | [attempt-4-row-action-list.md](attempt-4-row-action-list.md) |
| 批量操作数据表格 | `32de51627ece3f0b85b5ce45944b54d373ddfde720db6d85a29d9a074f3ce0ab` | `74d20633fe23fd893e45588de31379939c27d7c6552bbf8add23a81c6d8db97f` | [attempt-4-bulk-action-table.md](attempt-4-bulk-action-table.md) |
